...
WITH
s6  AS (INSERT INTO spec_option (spec_group_id, value, display_order) VALUES (1, '1 1/2 x 1 1/2', 3)  ON CONFLICT (spec_group_id, value) DO NOTHING RETURNING id),
s7  AS (INSERT INTO spec_option (spec_group_id, value, display_order) VALUES (1, '2 x 1 1/2', 4)       ON CONFLICT (spec_group_id, value) DO NOTHING RETURNING id),
s8  AS (INSERT INTO spec_option (spec_group_id, value, display_order) VALUES (1, '2 1/2 x 1 1/2', 5)   ON CONFLICT (spec_group_id, value) DO NOTHING RETURNING id),
s9  AS (INSERT INTO spec_option (spec_group_id, value, display_order) VALUES (1, '2 x 2', 6)           ON CONFLICT (spec_group_id, value) DO NOTHING RETURNING id),
s10 AS (INSERT INTO spec_option (spec_group_id, value, display_order) VALUES (1, '3 x 1 1/2', 7)       ON CONFLICT (spec_group_id, value) DO NOTHING RETURNING id),
s11 AS (INSERT INTO spec_option (spec_group_id, value, display_order) VALUES (1, '2 x 2 1/2', 8)       ON CONFLICT (spec_group_id, value) DO NOTHING RETURNING id),
s12 AS (INSERT INTO spec_option (spec_group_id, value, display_order) VALUES (1, '2 x 3', 9)           ON CONFLICT (spec_group_id, value) DO NOTHING RETURNING id),
s13 AS (INSERT INTO spec_option (spec_group_id, value, display_order) VALUES (1, '2 1/2 x 2 1/2', 10)  ON CONFLICT (spec_group_id, value) DO NOTHING RETURNING id),
s14 AS (INSERT INTO spec_option (spec_group_id, value, display_order) VALUES (1, '3 x 2 1/2', 11)      ON CONFLICT (spec_group_id, value) DO NOTHING RETURNING id),
s15 AS (INSERT INTO spec_option (spec_group_id, value, display_order) VALUES (1, '3 x 3', 12)          ON CONFLICT (spec_group_id, value) DO NOTHING RETURNING id),
s16 AS (INSERT INTO spec_option (spec_group_id, value, display_order) VALUES (1, '4 x 2', 13)          ON CONFLICT (spec_group_id, value) DO NOTHING RETURNING id),
s17 AS (INSERT INTO spec_option (spec_group_id, value, display_order) VALUES (1, '4 x 2 1/2', 14)      ON CONFLICT (spec_group_id, value) DO NOTHING RETURNING id),
s18 AS (INSERT INTO spec_option (spec_group_id, value, display_order) VALUES (1, '4 x 3', 15)          ON CONFLICT (spec_group_id, value) DO NOTHING RETURNING id),
s19 AS (INSERT INTO spec_option (spec_group_id, value, display_order) VALUES (1, '4 x 4', 16)          ON CONFLICT (spec_group_id, value) DO NOTHING RETURNING id),
s20 AS (INSERT INTO spec_option (spec_group_id, value, display_order) VALUES (1, '5 x 3', 17)          ON CONFLICT (spec_group_id, value) DO NOTHING RETURNING id),
s21 AS (INSERT INTO spec_option (spec_group_id, value, display_order) VALUES (1, '5 x 4', 18)          ON CONFLICT (spec_group_id, value) DO NOTHING RETURNING id),
s22 AS (INSERT INTO spec_option (spec_group_id, value, display_order) VALUES (1, '6 x 3', 19)          ON CONFLICT (spec_group_id, value) DO NOTHING RETURNING id),
s23 AS (INSERT INTO spec_option (spec_group_id, value, display_order) VALUES (1, '6 x 4', 20)          ON CONFLICT (spec_group_id, value) DO NOTHING RETURNING id),
s24 AS (INSERT INTO spec_option (spec_group_id, value, display_order) VALUES (1, '8 x 4', 21)          ON CONFLICT (spec_group_id, value) DO NOTHING RETURNING id),
