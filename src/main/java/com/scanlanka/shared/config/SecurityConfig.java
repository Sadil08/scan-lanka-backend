...
/**
 * Security baseline (global/02_SECURITY_BASELINE.md, global/08_THREAT_MODEL.md).
 * Transport + header hardening + CORS allow-list. Real authN/authZ (JWT httpOnly cookies, RLS GUC,
 * role gates) is added in Phase 1 (07-auth-accounts) — this is the secure-by-default skeleton.
 */
@Configuration
public class SecurityConfig {
    ...
    // Constructor injection only (global/09 §5) — @Value on the parameter, not a field.
